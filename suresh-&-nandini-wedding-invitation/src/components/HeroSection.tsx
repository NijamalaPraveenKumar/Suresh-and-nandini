    ...
    >
      ...
      <div className="absolute inset-0 z-0 overflow-hidden">
        <img
          src="/hero.png"
          alt="Suresh & Nandini"
          className="w-full h-full object-cover object-[80%_center] sm:object-[82%_center] lg:object-[85%_center] transition-transform duration-1000"
        />

        {/* Dark Midnight Navy Gradient Overlays to frame the text while keeping the couple clearly visible */}
        <div className="absolute inset-0 bg-gradient-to-r from-[#070b19]/90 via-[#070b19]/50 sm:via-[#070b19]/30 to-transparent" />
